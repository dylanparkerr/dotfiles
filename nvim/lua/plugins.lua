...
local plugins = {
    ...
    'ahmedkhalf/project.nvim', --git project switcher
    ...
    -- {'RRethy/vim-illuminate',commit='1b5d703'}, --highlight symbol under cursor
    ...
    --git
    'lewis6991/gitsigns.nvim', --visual git change indicators in gutters
